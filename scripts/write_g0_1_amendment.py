...
def main():
    ...
    bindings = {
        "original_g0_freeze_manifest": "data/manifests/confirmatory_v1/freeze_manifest.json",
        "hdf5_source_manifest": "data/manifests/1001g_hdf5_2026-09-22.json",
        "tracked_build_manifest": mirror,
        "formal_vcf_preflight": "data/manifests/formal_vcf_preflight_v1.json",
        "formal_genotype_qa": "data/manifests/formal_genotype_v1_qc.json",
        "trait_panel": "data/manifests/confirmatory_v1/trait_panel.tsv",
        "split_summary": "data/manifests/confirmatory_v1/split_summary.json",
        "nearclone_coordinate_panel": "data/manifests/confirmatory_v1/nearclone_v1/nearclone_marker_panel.tsv",
        "nearclone_sensitivity": "data/manifests/confirmatory_v1/nearclone_v1/nearclone_sensitivity.json",
        "nearclone_screened_exact_pairs": "data/manifests/confirmatory_v1/nearclone_exact_refinement/nearclone_screen_d002_exact_pairs.tsv",
        ...
        "nearclone_exact_blocks": "data/manifests/confirmatory_v1/nearclone_exact_refinement/nearclone_blocks_exact_d001.tsv",
        "original_analysis_plan_v1": "data/manifests/confirmatory_v1/analysis_plan_v1.json",
        "amended_analysis_plan_v1_1": "data/manifests/confirmatory_v1_1/analysis_plan_v1_1.json",
        "baseline_spec_v1": "data/manifests/confirmatory_v1_1/baseline_spec_v1.json",
        "common_feasibility": "data/manifests/confirmatory_v1_1/common_feasibility.tsv",
        "common_feasibility_summary": "data/manifests/confirmatory_v1_1/common_feasibility_summary.json",
    }
    ...
    manifest = {
        ...
        "artifact_bindings": {name: digest(path) for name, path in bindings.items()},
